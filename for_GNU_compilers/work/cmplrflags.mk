...
ifeq ($(compiler),intel-lonestar)
  ...
  DPRE          :=  -DREAL8 -DLINUX -DRKSSP -DOUT_TEC -DSWAN #-DSLOPE5 #-DARTDIF  # -DWETDR -DSLOPE5 #-DSED_LAY #-DOUT_TEC #-DSWAN #-DSLOPE5 -DRKC -DTRACE -DSED_LAY -DCHEM -DP0 -DP_AD -DSLOPEALL
  DPRE2         :=  -DREAL8 -DLINUX -DCMPI 
  CFLAGS        :=  -O3 -xSSSE3 -I.
  IMODS         :=  -I
  LIBS          :=  -L ../metis -lmetis
...
ifeq ($(compiler),gfortran)
  ...
  FC            :=  gfortran
  PFC           :=  mpif90
  FFLAGS1       :=  -ffixed-line-length-none -finit-local-zero

  FFLAGS2       :=  $(FFLAGS1)
  FFLAGS3       :=  $(FFLAGS1)
  FFLAGS4       :=  $(FFLAGS1)
  DA            :=  -DREAL8 -DLINUX -DCSCA -DGFORTRAN -DRKSSP -DWETDR -DOUT_TEC
  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DGFORTRAN -DRKSSP -DWETDR -DOUT_TEC
  DPRE          :=  -DREAL8 -DLINUX -DGFORTRAN -DRKSSP -DWETDR -DOUT_TEC -DSWAN
  DPRE2         :=  -DREAL8 -DLINUX -DGFORTRAN -DCMPI
  IMODS         :=  -I
  CC            :=  gcc
  CFLAGS        :=  -I. -O2 -DLINUX -std=c89
