submodule (piodg:piodg_nodal_scalar_sub) piodg_tracer_sub
    ...
    module procedure piodg_tracer_open
        ...
        call self%piodg_nodal_scalar%open(piosystem, self%path, the_piotype, &
            the_omode)
    end procedure piodg_tracer_open

end submodule piodg_tracer_sub
