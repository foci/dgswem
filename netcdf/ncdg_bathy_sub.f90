submodule (ncdg:ncdg_nodal_scalar_sub) ncdg_bathy_sub
!! Implementation of fort.63.nc
    ...
    module procedure ncdg_bathy_create
        ...
        ! Set scalar name
        self%scalar_varname = "depth"

        ! Call parent function
        call self%ncfile%create(path=the_path, cmode=the_cmode)

        deallocate(the_path)
    end procedure ncdg_bathy_create

    module procedure ncdg_bathy_open
        ! See interface for arguments and documentation
    ...
    end procedure ncdg_bathy_open

    module procedure ncdg_bathy_set_metadata
        ! See interface for arguments and documentation
        ...
        ncstat = nf90_put_att(self%ncid, self%scalar_varid, &
            "long_name", "bathymetry depth below geoid")
        call ncfile_check_error(ncstat)
        ncstat = nf90_put_att(self%ncid, self%scalar_varid, &
        ...
        ! N/A, for now
    end procedure ncdg_bathy_set_metadata

end submodule ncdg_bathy_sub
