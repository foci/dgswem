...
!     triad interactions
      ...
      PTRIAD(2)  = 2.5                                                    40.61 40.55 30.82
      PTRIAD(3)  = 10.                                                    40.23
      PTRIAD(4)  = 0.2                                                    40.13
      PTRIAD(5)  = 0.01                                                   40.23
!
...
!
!       --- check if output location is in global subdomain               40.95
!
        IF ( MNPROC.GT.1 .AND. .NOT.SINCMP ) THEN                         40.95
           IF ( XP.GE.XCGMIN .AND. XP.LE.XCGMAX .AND.                     40.95
     &          YP.GE.YCGMIN .AND. YP.LE.YCGMAX ) SINCMP = .TRUE.         40.95
        ENDIF                                                             40.95
!
      ENDIF
!
...
!
      CHARACTER BTYPE *4, HEDLIN *80, TIMSTR *20, CDATE *12,
     &          DATITM(5) *18, SWWDATE*15, PTNME*12
!     BTYPE     type of boundary condition
!     HEDLIN    heading line
!     TIMSTR    time string
!     CDATE     date-time read from file
!
...
!Casey 080116: If we have coupled to the water levels from ADCIRC,
