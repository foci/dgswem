...
ifeq ($(compiler),intel-lonestar)
  ...
  FFLAGS3       :=  $(FFLAGS1)
  FFLAGS4       :=  $(FFLAGS1)
  DA            :=  -DREAL8 -DLINUX -DCSCA -DRKSSP -DOUT_TEC -DTRACE #-DARTDIF  #  -DWETDR -DSLOPE5 # -DSED_LAY -DOUT_TEC #-DRKC -DTRACE -DSED_LAY -DCHEM -DP0 -DP_AD -DSLOPEALL -DFILTER
  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DRKSSP -DOUT_TEC -DTRACE #-DARTDIF #-DWETDR -DSLOPE5 # -DSED_LAY -DRKC -DTRACE -DSED_LAY -DCHEM -DP0 -DP_AD -DSLOPEALL
  DPRE          :=  -DREAL8 -DLINUX -DRKSSP -DOUT_TEC -DTRACE #-DARTDIF  # -DWETDR -DSLOPE5 #-DSED_LAY -DSWAN #-DOUT_TEC #-DSWAN #-DSLOPE5 -DRKC -DTRACE -DSED_LAY -DCHEM -DP0 -DP_AD -DSLOPEALL
  DPRE2         :=  -DREAL8 -DLINUX -DCMPI 
  CFLAGS        :=  -O3 -xSSSE3 -I.
  IMODS         :=  -I
  LIBS          :=  -L ../metis -lmetis
